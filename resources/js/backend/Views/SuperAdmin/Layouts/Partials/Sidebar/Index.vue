<template>
  ...
  <div id="sidebar-wrapper">
    ...
    <ul class="metismenu" id="menu">
      ...
      <side-bar-single-menu :icon="`fa fa-money`" :menu_title="`Payment Gateways`" :route_name="`AllPaymentGateways`" />
      <side-bar-single-menu :icon="`fa fa-envelope`" :menu_title="`Email Configures`" :route_name="`AllEmailConfigures`" />
      <!-- Management end -->
    </ul>
  </div>
</template>
