...
namespace App\Modules\Management\CourseManagement\CourseModuleClassResourse\Actions;
...
class GetAllData
{
    ...
    $q->orWhere('resourse_content', 'like', '%' . $searchKey . '%');    

    $q->orWhere('resourse_link', 'like', '%' . $searchKey . '%');              
